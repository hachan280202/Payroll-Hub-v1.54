                    ...
                    ...(isOpen
                      ? rows.map((e, ri) => {
                          ...
                          return (
                            <tr
                              key={e.id}
                              className={`group ${isRowDimmed ? "opacity-35 select-none bg-slate-100/50 dark:bg-slate-800/10 italic text-muted-foreground/60 line-through" : ri % 2 === 0 ? "bg-[var(--stripe-color1,white)]" : "bg-[var(--stripe-color2,#fdfcf9)]"} hover:bg-slate-50 transition-colors`}
                            >
