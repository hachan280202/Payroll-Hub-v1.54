...
export function calculateTimesheet(params: any) {
  ...
  if (cenResult.length > 0) {
    ...
    cenResult.forEach((c: any) => {
      totalRow.chargeLxo += (c.chargeLxo || 0);
      totalRow.chargeEc += (c.chargeEc || 0);
      totalRow.chargePtDemo += (c.chargePtDemo || 0);
      totalRow.chargeMktLocal += (c.chargeMktLocal || 0);
      totalRow.chargeRenewalProjects += (c.chargeRenewalProjects || 0);
      totalRow.chargeDiscoveryCamp += (c.chargeDiscoveryCamp || 0);
      totalRow.chargeSummerOuting += (c.chargeSummerOuting || 0);
      totalRow.chargeSummerInstructors += (c.chargeSummerInstructors || 0);
      totalRow.totalSalary += (c.totalSalary || 0);
    });
    cenResult.push(totalRow);
  }
